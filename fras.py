...
cl = LINETCR.LINE()
#cl.login(qr=True)
cl.login(token='Eog1BwiKbwDo9IgD4lhe.aku80kLE5LiX9n8yeExzlG.qLcuoRGUQSWOgMZgE0Em9xvJnWlFN1hlsQZ0YBmLZOw=')
cl.loginResult()
print "Cl-Login Success\n"

ki = LINETCR.LINE()
#ki.login(qr=True)
ki.login(token='Eo25lstsgJUOndfNTWec.jFGC7fqRUB/KtU5LBYaMNa.K5P1UKWcXmQnnFM/KpY2ZEEqytK3B0D35ZzmORhSZII=')
ki.loginResult()
print "Ki-Login Success\n"

kk = LINETCR.LINE()
#kk.login(qr=True)
kk.login(token='EoaBacmdx3cnXciYw1na.CZgRpE2PgJOBF+NlS+sJoG.PJ08yzjiUcbYJobUvcfdKVnSc3KIYsCjxHqkQp8Y0lg=)
kk.loginResult()
print "Kk-Login Success\n"

kc = LINETCR.LINE()
#kc.login(qr=True)
kc.login(token='EoRWPq418YxeZTqMuo1b.I9YBMfRqAE5FKjP6B2coYW.qntC1jHBjYSQ8oods2fJO3/P+BX+8Z5Rier0RbMPvMs=')
kc.loginResult()
print "Kc-Login Success\n"

kr = LINETCR.LINE()
#kr.login(qr=True)
kr.login(token='EoVAUOfVFcsGBFvwwA02.N/RlxRz2fWJfjPHay81q4G.B065H2I5C1ckku6Te30HtOhRVAj8GelARPSbsHDArmU=')
kr.loginResult()
print "Kr-Login Success\n"

#km = LINETCR.LINE()
#km.login(qr=True)
#km.login(token='EoWUqmgcQ1IonqUBevJe./8qACtmK1gbHjswou8E6+G.bsKBRj6UNKgV2O1lBNFg9ai/9MUWCySoMqOVpv50lD4=')
#mkm.loginResult()
...
#--------------------------------------------------------
                ...
                midd = msg.text.replace("Invite creator ","u62dd9c1d03eb2e34dfc0dc629420fcac")
                cl.findAndAddContactsByMid(midd)
                cl.inviteIntoGroup(msg.to,[midd])
#--------------------------------------------------------
...
#--------------------------------------------------------
		...
		cl.sendText(msg.to,"FAF READY")
                ki.sendText(msg.to,"FAF READY")
                kk.sendText(msg.to,"FAF READY")
                kc.sendText(msg.to,"FAF READY")
                kr.sendText(msg.to,"FAF READY")
...
#--------------------------------------------------------
            elif "@􀐂􀆭􏿿Fras" in msg.text:
              if wait["Tag"] == True:
                tanya = msg.text.replace("@􀐂􀆭􏿿Fras","")
                jawab = ("kangen yach kok Tag aq","Hayo ngaku klo kangen aq","Bos q gi bobok","Bos q masih kerja","Bos gi OTW","Fras Lagi Off...\nKalau Penting PC Aja Fras nya")
